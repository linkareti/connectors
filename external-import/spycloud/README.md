# OpenCTI Spycloud Ingestion Connector
...
- [OpenCTI Spycloud Ingestion Connector](#opencti-spycloud-ingestion-connector)
...
Then, start the connector from spycloud/src:
