# OpenCTI Censys Internal Enrichment Connector
...
- [OpenCTI Censys Internal Enrichment Connector](#opencti-censys-internal-enrichment-connector)
...
| Connector Auto  | connector_auto	 | `CONNECTOR_AUTO`            | False           | Yes       | Must be `true` or `false` to enable or disable auto-enrichment of observables            |
